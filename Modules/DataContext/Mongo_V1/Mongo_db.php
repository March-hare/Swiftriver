...
class Mongo_db
{
	...
	public function __construct($host, $port, $user, $pass, $dbname, $persist, $persist_key)
	{
  ...
  public function delete_all($collection = "")
  {
	...
	private function connection_string($host, $port, $user, $pass, $dbname, $persist, $persist_key)
	{
		$this->host = trim($host);
		$this->port = trim($port);
		$this->user = trim($user);
		...
		$this->persist = trim($persist);
		$this->persist_key = trim($persist_key);
